...
/*
    ...
    - 퍼블릭 필드 : public
    - 프라이빗 필듯 : private
    - 정적(스태틱) 퍼블릭 필드 : static public
    - 정적(스테틱) 프라이빗 필드 : static private
*/ 
class Sample1 {
    // 퍼블릭 필드
    publicField;
...
/*
    getter, setter : -> private필드를 속성 접근하듯이 사용할수 있게 함
...
Sample3.staticMethod(); // 클래스로 직접 호출해야함
