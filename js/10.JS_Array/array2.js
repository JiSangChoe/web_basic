...
/*
    ...
    - 단순 .sort()로 정렬하면 사전식(아스키코드) 정렬을 하게됨
*/
// array.sort();
// console.log(array);
...
/*
    ...
    - for 문보다 성능 떨어짐, 가독성이 좋고 편리하므로 자주 사용
...
/*
    ...
    - 원본 배열 변경X
    - forEach 단순히 요소를 가지고 작업만 진행(반환값X), map 요소를 가지고 작업한 결과로 배열을 새로 만듬(반드시 반환값O)
*/
...
/*
    find(콜백 함수) : 콜백 함수를 결과가 true인 첫번째 요소를 반환
*/
