...
/*
    비교 연산자 : 좌항과 우항이 같은지 비교 논리 값을 반환
    - == : 동등 비교
    - === : 일치 비교 
    - != : 부등 비교
    - !== 불일치 비교
...
console.log(10==='10'); // false (타입까지 같은지 비교) 
...
/*
    ...
    - <= : 좌항이 우항보다 작거나 같다
*/
console.log(10 > '9'); // true (타입을 비교하지 않고 비교)
...
let result2 = number % 2 ? '홀수':'짝수' // number % 2 가 참이냐 거짓이냐에 따라 연산가능
console.log(result2); 
